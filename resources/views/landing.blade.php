...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero { background: linear-gradient(135deg, #1A5C2A 0%, #276B35 100%); min-height: 88vh; display: flex; align-items: center; padding: 60px 40px; gap: 60px; }
        ...
        .feature-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 24px; max-width: 1000px; margin: 0 auto; }
        .feature-card { background: #fff; border-radius: 12px; padding: 32px 24px; box-shadow: 0 2px 12px rgba(0,0,0,0.07); border-top: 4px solid #276B35; }
        ...
        .footer { background: #1A5C2A; color: #A8D5B5; text-align: center; padding: 28px 40px; font-size: 14px; }
    </style>
</head>
<body>
    <nav class="navbar">
    ...
    <section class="hero">
        <div class="hero-text">
            ...
            <p>A centralized platform for managing student enrollment records at Gordon College, Olongapo City. Fast, secure, and easy to use.</p>
